...
namespace AbpNet8.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class AbpNet8ScriptSrcTagHelper : TagHelper
    {
        ...
        public AbpNet8ScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
