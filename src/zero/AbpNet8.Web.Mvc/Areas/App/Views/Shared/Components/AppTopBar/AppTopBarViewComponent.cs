...
namespace AbpNet8.Web.Areas.App.Views.Shared.Components.AppTopBar
{
    public class AppTopBarViewComponent : AbpNet8ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            using (var ouw = _unitOfWorkManager.Begin())
            {
                ...
                headerModel.ProfileImage = @"\Common\Images\default-profile-picture.png";
                ouw.Complete();
