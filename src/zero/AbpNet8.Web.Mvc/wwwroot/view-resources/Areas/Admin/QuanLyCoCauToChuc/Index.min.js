(function () {
    $(function () {
        ...
        var _createToChucModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/QuanLyCoCauToChuc/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/QuanLyCoCauToChuc/_CreateModal.js',
            modalClass: 'CreateModal'
        });

        var _editToChucModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/QuanLyCoCauToChuc/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Admin/QuanLyCoCauToChuc/_EditModal.js',
        ...
        $('#ThemToChuc').click(function () {
            _createToChucModal.open({ id: undefined, chaid: undefined });
        });
