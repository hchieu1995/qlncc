! function ($) {
    ...
    MultiSelect.prototype = {
        ...
        them_phantrang: function (options) {
            debugger;
            this.$element.find('option:not(:selected)').remove();
            this.$selectableUl.find(".ms-elem-selectable:not(.ms-selected)").remove();
            this.$selectionUl.find(".ms-elem-selection:not(.ms-selected)").remove();
