...
namespace AbpNet8.Configuration
{
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!AbpNet8Consts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings, GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings, AbpNet8Consts.MultiTenancyEnabled? "true":"false"), scopes: SettingScopes.Tenant)
            };
        }
