...
{
    public class KyHoaDonToken_TaiXmlChuaKyInput
    {
        public string doanhnghiep_mst { get; set; }
        public string magiaodich { get; set; }
        public string ma_hoadon { get; set; }
    }
    public class KyHoaDonToken_TaiXmlChuaKyOutput
    {
    ...
    public class KyHoaDonToken_TaiXmlDaKyInput
    {
        public string doanhnghiep_mst { get; set; }
        public string magiaodich { get; set; }
        public string ma_hoadon { get; set; }
    }
    public class KyHoaDonToken_TaiXmlDaKyOutput
    {
        public string maketqua { get; set; } = "02";
        public string motaketqua { get; set; } = "Không tìm thấy thông tin hóa đơn";
